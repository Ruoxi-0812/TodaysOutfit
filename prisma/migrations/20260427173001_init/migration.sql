-- CreateEnum
CREATE TYPE "Category" AS ENUM ('TOPS', 'BOTTOMS', 'DRESSES', 'OUTERWEAR', 'SHOES', 'BAGS', 'JEWELRY', 'ACCESSORIES');
...
-- CreateTable
CREATE TABLE "OneOffItem" (
    "id" TEXT NOT NULL,
    "outfitId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,

    CONSTRAINT "OneOffItem_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "OneOffItem" ADD CONSTRAINT "OneOffItem_outfitId_fkey" FOREIGN KEY ("outfitId") REFERENCES "Outfit"("id") ON DELETE CASCADE ON UPDATE CASCADE;
